...
/**
 * Igual que `authenticateJWT` si hay Bearer válido.
 * Sin token: `req.auth = null` (sin 401). Bearer inválido → 401.
 * En desarrollo, mismas cabeceras `x-dev-user` / `x-dev-tenant` que `authenticateJWT`.
 */
