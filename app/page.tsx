...
export default function MultaCheck() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      {/* Estilos inyectados directamente para asegurar que se vea bien en Vercel */}
      <style jsx global>{`
      ...
      <main className="max-w-4xl mx-auto pt-16 px-4 pb-20">
        ...
        <div className="bg-white p-2 rounded-2xl shadow-2xl border border-slate-200 mb-16">
          <div className="flex flex-col md:flex-row gap-2">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all transform hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-blue-200">
              Analizar Acta
            </button>
          </div>
        </div>
